 ...
 * L'objectif est de générer un programme correct et fonctionnel à partir du langage MML
 * dans le langage de programmation ciblé.
 * 
 * @author Fabien
 *
 * @param <M> Le type de méta-modèle utilisé par le compilateur pour générer les programmes
 */
public interface Compiler<M> extends ProgramStructure {
	...
	/**
	 * Renvoie la chaîne de caractère correspondant au code source généré par le compilateur.
	 * @return
	 */
	String printCode();
	 ...
	 * @return true si le compilateur supporte le framework en paramètre, false sinon
	 */
	 ...
	 * @return true si le framework et le langage de programmation supporte l'algorithme en paramètre
	 */
	boolean supportAlgorithm(AlgorithmEnum algo);
	
	/**
	 * Indique si le langage et le framework ciblé par le compilateur supporte 
	 * la métrique en paramètre
	 * @param metric La métrique pour laquelle vérifier
	 * @return true si le framework et le langage de programmation supporte la métrique en paramètre
	 */
