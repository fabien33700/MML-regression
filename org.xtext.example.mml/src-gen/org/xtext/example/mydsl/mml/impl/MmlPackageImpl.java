...
public class MmlPackageImpl extends EPackageImpl implements MmlPackage
{
  ...
  {
    return (EAttribute)svrEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(svrEClass, SVR__C);
    createEAttribute(svrEClass, SVR__KERNEL);
  ...
  public void initializePackageContents()
  {
    ...
    svrEClass.getESuperTypes().add(this.getMLAlgorithm());
    dtEClass.getESuperTypes().add(this.getMLAlgorithm());
    randomForestEClass.getESuperTypes().add(this.getMLAlgorithm());
    sgdEClass.getESuperTypes().add(this.getMLAlgorithm());
    gtbEClass.getESuperTypes().add(this.getMLAlgorithm());
    ...
    initEClass(svrEClass, org.xtext.example.mydsl.mml.SVR.class, "SVR", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getSVR_C(), ecorePackage.getEString(), "C", null, 0, 1, org.xtext.example.mydsl.mml.SVR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSVR_Kernel(), this.getSVMKernel(), "kernel", null, 0, 1, org.xtext.example.mydsl.mml.SVR.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(gtbEClass, org.xtext.example.mydsl.mml.GTB.class, "GTB", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
